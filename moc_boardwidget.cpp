...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BoardWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 39, 4)
    ...
    "BoardWidget\0cellClicked\0\0BoardPosition\0"
    "cell"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->cellClicked((*reinterpret_cast< const BoardPosition(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (BoardWidget::*_t)(const BoardPosition );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BoardWidget::cellClicked)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject BoardWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BoardWidget.data,
      qt_meta_data_BoardWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BoardWidget.stringdata))
...
// SIGNAL 0
void BoardWidget::cellClicked(const BoardPosition _t1)
{
