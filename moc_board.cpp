...
QT_MOC_LITERAL(11, 90, 6)
    ...
    "Board\0boardChanged\0\0moveMade\0CELL_STATE\0"
    "player\0nextTurn\0countChanged\0white\0"
    "black\0gameOver\0winner"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->moveMade((*reinterpret_cast< CELL_STATE(*)>(_a[1])),(*reinterpret_cast< CELL_STATE(*)>(_a[2]))); break;
        case 2: _t->countChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->gameOver((*reinterpret_cast< CELL_STATE(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::boardChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Board::*_t)(CELL_STATE , CELL_STATE );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::countChanged)) {
                *result = 2;
            }
        }
        {
            typedef void (Board::*_t)(CELL_STATE );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Board::gameOver)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 1
void Board::moveMade(CELL_STATE _t1, CELL_STATE _t2)
{
...
// SIGNAL 2
void Board::countChanged(int _t1, int _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 3
void Board::gameOver(CELL_STATE _t1)
{
